  ...
  {:powergrid-client
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"powergrid_client/rendering.js"]}}
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/powergrid-client-dev.html"
                            :name "Development"
                            :out-file "powergrid-client-dev.js"
                            :main 'powergrid_client.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :output-root :tools-public
                      :template "tooling.html"}
              :production {:uri "/powergrid-client.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "powergrid-client.js"
                           :main 'powergrid_client.start
                           :order 5}}}})
