...
try {
  ...
  if(cljs.core.instance_QMARK_.call(null, ReferenceError, e3991)) {
    var __3992 = e3991;
...
powergrid_client.client.log = function() {
  var a = function(a) {
  ...
  a.appendChild(dommy.template.__GT_node_like.call(null, function c(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        ...
        !0), cljs.core.PersistentVector.fromArray(["\ufdd0'span.resource.garbage"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'span.resource.garbage"], !0)], !0)], !0), c.call(null, cljs.core.rest.call(null, a)))) : null
      }
    }, null)
  }.call(null, cljs.core.range.call(null, 1, 9))));
  a.appendChild(dommy.template.__GT_node_like.call(null, function d(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        var f = cljs.core.seq.call(null, a);
        return f ? (f = cljs.core.first.call(null, f), cljs.core.cons.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", cljs.core.ObjMap.fromObject(["\ufdd0'data-resource-cost"], {"\ufdd0'data-resource-cost":f}), cljs.core.PersistentVector.fromArray(["\ufdd0'span.resource-block-cost", f], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'div", cljs.core.PersistentVector.fromArray(["\ufdd0'span.resource.uranium"], !0)], !0)], !0), d.call(null, cljs.core.rest.call(null, a)))) : null
      }
    }, null)
...
powergrid_client.client.resource_name = function(a) {
  return cljs.core.set_QMARK_.call(null, a) ? clojure.string.join.call(null, "-", cljs.core.sort.call(null, cljs.core.map.call(null, cljs.core.name, a))) : cljs.core.name.call(null, a)
};
powergrid_client.client.power_plant_tpl = function(a) {
  ...
  cljs.core.truth_(cljs.core.format.call(null, "%s power-plant-%d", powergrid_client.client.resource_name.call(null, a), e)) && (b.className = [cljs.core.str(b.className), cljs.core.str(" "), cljs.core.str(cljs.core.format.call(null, "%s power-plant-%d", powergrid_client.client.resource_name.call(null, a), e))].join("").trim());
...
powergrid_client.client.power_plants_tpl = function(a) {
  ...
  b.appendChild(function() {
    var a = document.createElement("h3");
    a.appendChild(document.createTextNode("Power Plants"));
    return a
  }());
  b.appendChild(function() {
    var b = document.createElement("div");
...
powergrid_client.client.game_tpl = function(a) {
  ...
  b.appendChild(function() {
    ...
    a.appendChild(function() {
      var a = document.createElement("h3");
      a.appendChild(document.createTextNode("Players"));
      return a
    }());
...
powergrid_client.client.update_resource = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, d = cljs.core._lookup.call(null, c, "\ufdd0'pricing", null), c = cljs.core._lookup.call(null, c, "\ufdd0'market", null), e = cljs.core.count.call(null, d) - c;
  return cljs.core.doall.call(null, cljs.core.map_indexed.call(null, function(a, b) {
    powergrid_client.client.log.call(null, a, b, e);
    return dommy.core.toggle_class_BANG_.call(null, b, "unavailable", a < e)
  }, b))
};
powergrid_client.client.update_resources = function(a) {
  for(var b = cljs.core.seq.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'coal", "\ufdd0'oil", "\ufdd0'garbage", "\ufdd0'uranium"], !0));;) {
    if(b) {
      var c = cljs.core.first.call(null, b);
      powergrid_client.client.update_resource.call(null, cljs.core._lookup.call(null, a, c, null), dommy.utils.__GT_Array.call(null, document.querySelectorAll(dommy.core.selector.call(null, [cljs.core.str("#resources ."), cljs.core.str(cljs.core.name.call(null, c))].join("")))));
      b = cljs.core.next.call(null, b)
    }else {
      return null
    }
...
var std_pricing_3250 = function() {
  return function b(c) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(var d = c;;) {
        var e = cljs.core.seq.call(null, d);
        if(e) {
          var f = e, g = cljs.core.first.call(null, f), e = function(b, c) {
            return function k(b) {
              return new cljs.core.LazySeq(null, !1, function() {
                for(;;) {
                  var d = cljs.core.seq.call(null, b);
                  return d ? (cljs.core.first.call(null, d), cljs.core.cons.call(null, c, k.call(null, cljs.core.rest.call(null, b)))) : null
                }
              }, null)
            }
          }(d, g, f, e);
...
}(), uranium_pricing_3251 = cljs.core.with_meta(cljs.core.list(1, 2, 3, 4, 5, 6, 7, 8, 12, 14, 15, 16), cljs.core.hash_map("\ufdd0'line", 91, "\ufdd0'column", 24));
powergrid_client.client.mock_game = cljs.core.ObjMap.fromObject(["\ufdd0'players", "\ufdd0'resources", "\ufdd0'power-plants", "\ufdd0'turn-order", "\ufdd0'turns"], {"\ufdd0'players":cljs.core.PersistentArrayMap.fromArrays([1, 2], [cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'username", "\ufdd0'color", "\ufdd0'money", "\ufdd0'power-plants"], {"\ufdd0'id":1, "\ufdd0'username":"Logan", "\ufdd0'color":"\ufdd0'red", "\ufdd0'money":50, "\ufdd0'power-plants":cljs.core.ObjMap.EMPTY}), cljs.core.ObjMap.fromObject(["\ufdd0'id", 
"\ufdd0'username", "\ufdd0'color", "\ufdd0'money", "\ufdd0'power-plants"], {"\ufdd0'id":2, "\ufdd0'username":"Maeby", "\ufdd0'color":"\ufdd0'black", "\ufdd0'money":50, "\ufdd0'power-plants":cljs.core.ObjMap.EMPTY})]), "\ufdd0'resources":cljs.core.ObjMap.fromObject(["\ufdd0'coal", "\ufdd0'oil", "\ufdd0'garbage", "\ufdd0'uranium"], {"\ufdd0'coal":cljs.core.ObjMap.fromObject(["\ufdd0'market", "\ufdd0'supply", "\ufdd0'pricing"], {"\ufdd0'market":24, "\ufdd0'supply":0, "\ufdd0'pricing":std_pricing_3250}), 
"\ufdd0'oil":cljs.core.ObjMap.fromObject(["\ufdd0'market", "\ufdd0'supply", "\ufdd0'pricing"], {"\ufdd0'market":18, "\ufdd0'supply":6, "\ufdd0'pricing":std_pricing_3250}), "\ufdd0'garbage":cljs.core.ObjMap.fromObject(["\ufdd0'market", "\ufdd0'supply", "\ufdd0'pricing"], {"\ufdd0'market":6, "\ufdd0'supply":18, "\ufdd0'pricing":std_pricing_3250}), "\ufdd0'uranium":cljs.core.ObjMap.fromObject(["\ufdd0'market", "\ufdd0'supply", "\ufdd0'pricing"], {"\ufdd0'market":2, "\ufdd0'supply":10, "\ufdd0'pricing":uranium_pricing_3251})}), 
"\ufdd0'power-plants":cljs.core.ObjMap.fromObject(["\ufdd0'market", "\ufdd0'future", "\ufdd0'deck"], {"\ufdd0'market":powergrid_client.power_plants.initial_market.call(null), "\ufdd0'future":powergrid_client.power_plants.initial_future.call(null), "\ufdd0'deck":powergrid_client.power_plants.initial_deck.call(null)}), "\ufdd0'turn-order":cljs.core.PersistentVector.fromArray([1, 2], !0), "\ufdd0'turns":cljs.core.List.EMPTY});
...
powergrid_client.client.update_resources.call(null, (new cljs.core.Keyword("\ufdd0'resources")).call(null, powergrid_client.client.mock_game));
